...
public class AddIncomeActivity extends AppCompatActivity implements View.OnClickListener,NumberPickerDialogFragment.NumberPickerDialogHandlerV2, DatePickerDialog.OnDateSetListener {
    ...
    final String [] typeName = new String [] {"公司收入","投資收入","其他"};
    final int [] iconIdArray = new int[] {R.drawable.company,R.drawable.bank,R.drawable.other};
    ...
    public class UpdateData extends AsyncTask<Void, Void, Void> {     //This class use to load the data from server first time
        ...
        {
            dialog = new MaterialDialog.Builder(AddIncomeActivity.this)
                    .content("正在儲存資料...")
                    .progress(true, 0)
        ...
        protected Void doInBackground(Void... params)
        {
            ...
            newIncome = Integer.parseInt(LocalDB.getDataBySQL("SELECT income FROM SettingRecord",0,"income"))+ExchangeRateConvertor.convertRate("HKD",currencyUnit, Integer.parseInt(cash));
